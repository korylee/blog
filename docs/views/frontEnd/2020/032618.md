...
![红色标识为特例](https://upload-images.jianshu.io/upload_images/5376626-8f56be1cb904b5e9.png?imageMogr2/auto-orient/strip|imageView2/2/w/510/format/webp)
...
> 先初始化 Foo 的实例对象，然后将其原型上的 getName 函数作为构造函数再次 new，所以最终结果为 3
